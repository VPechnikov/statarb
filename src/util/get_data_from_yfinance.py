...
def get_ticker_data(ticker) -> yf_ticker:
    """
    Parameters:
        ticker (str): an abbreviation used uniquely identify publicly traded shares of a particular stock

    Returns:
        ticker_class (yf_ticker): yf_ticker object initialised with balance sheet, cashflow, info,
                                  and close prices.
    """
